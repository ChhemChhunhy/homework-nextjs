    ...
    return (
            ...
            <div>
                <form className="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <TextInput id="fullname1" type="email" placeholder="Chhem Chhunhy" required/>
                    </div>
                    <div>
                        <div className="mb-2 block ">
            ...
            <div>
                <form className="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <TextInput id="email1" type="email" placeholder="chhunhychhynhy121828@gmail.com" required/>
                    </div>
                    <div>
                        <div className="mb-2 block">
                        ...
                        <TextInput id="username3" placeholder="999948397 (Telegram)" addon="+855" required/>
                    </div>
                    <div>
                        <div className="mb-2 block ">
        ...
        <div className="px-14">
            ...
            <div className="py-2 text-red-500 font-bold">
                <h3>👉 Please select course that available class ....!</h3>
            </div>
        </div>
        {/*Button*/}
